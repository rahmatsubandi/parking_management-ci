    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if (in_array('createParking', $user_permission)) : ?>
          <a href="<?php echo base_url('parking/create') ?>" class="btn btn-primary"> <i class="fa fa-plus"></i></a>
          <br /> <br />
        <?php endif; ?>
                      ...
                      <td>
                        <div class="btn btn-group-sm">
                          ...
                          <?php if (in_array('viewParking', $user_permission)) : ?>
                            <a onclick="printParking(<?php echo "'" . base_url('parking/printInvoice/' . $v['parking']['id']) . "'"; ?>)" class="btn btn-success"><i class="fa fa-print"></i></a>
                          <?php endif; ?>
                        </div>
                      </td>
                    <?php endif; ?>
